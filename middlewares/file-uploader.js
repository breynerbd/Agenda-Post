...
export const uploadContactImage = createCloudinaryUploader(
    process.env.CLOUDINARY_FOLDER || 'kinal_agend/contacts'
);
 
export const uploadTaskImage = createCloudinaryUploader(
    process.env.CLOUDINARY_TEAMS_FOLDER || 'kinal_agend/tasks'
);
